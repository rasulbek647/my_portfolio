...
def _stroke_wrap(inner: str) -> str:
    return (
        f'<svg class="h-6 w-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" '
...
_ICONS: dict[str, str] = {
    ...
    "musical": '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19V6l12-3v13M9 19c0 1.105-1.343 2-3 2s-3-.895-3-2 1.343-2 3-2 3 .895 3 2zm12-3c0 1.105-1.343 2-3 2s-3-.895-3-2 1.343-2 3-2 3 .895 3 2zM9 10l12-3"/>',
...
def svg_for_icon(icon_key: str | None) -> str:
    k = (icon_key or "").strip().lower()
    if k not in _ICONS:
        k = "link"
    return _stroke_wrap(_ICONS[k])
