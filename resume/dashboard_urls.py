...
urlpatterns = [
    ...
    path("services/", v.service_list, name="services"),
    path("services/new/", v.service_create, name="service_create"),
    path("services/<int:pk>/edit/", v.service_edit, name="service_edit"),
    path("services/<int:pk>/delete/", v.service_delete, name="service_delete"),
